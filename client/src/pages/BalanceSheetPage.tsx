...
function AssetModal({ item, pending, options, onManageOrganization, onClose, onSave }: {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="asset-modal-title" className="drawer-backdrop-enter fixed inset-0 z-[80] flex justify-end bg-[#07150d]/45 p-3 backdrop-blur-[3px] sm:p-4" onMouseDown={event => event.target === event.currentTarget && onClose()}>
    ...
    <main className="min-h-screen w-full bg-[#EFF4F1] text-[#0B1F14]">
      <div className="flex min-h-screen w-full gap-5 p-3 sm:p-5">
        ...
        <section className="flex min-w-0 flex-1 flex-col gap-4">
          ...
          {overviewQuery.isLoading && <section className="flex min-h-[520px] flex-1 items-center justify-center rounded-[20px] bg-white ring-1 ring-[#E1E8E3]"><GranafyLoader label="Montando o balanço..." /></section>}
